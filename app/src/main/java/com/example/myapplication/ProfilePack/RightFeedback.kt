...
import com.example.myapplication.databinding.ActivityRightFeedbackBinding

class RightFeedback : AppCompatActivity() {
    private lateinit var binding: ActivityRightFeedbackBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRightFeedbackBinding.inflate(layoutInflater)
